...
public class GmallSearchServiceApplicationTests {
    ...
    public void put() throws IOException {
        ...
        for (PmsSearchSkuInfo pmsSearchSkuInfo : pmsSearchSkuInfos) {
            Index put = new Index.Builder(pmsSearchSkuInfo).index("gmall0228").type("PmsSkuInfo").id(pmsSearchSkuInfo.getId()+"").build();
    ...
    public void get() throws IOException {
        ...
        TermQueryBuilder termQueryBuilder1 = new TermQueryBuilder("skuAttrValueList.valueId","65");
        boolQueryBuilder.filter(termQueryBuilder1);
        TermsQueryBuilder termsQueryBuilder = new TermsQueryBuilder("skuAttrValueList.valueId","81","64");
